...
-- ALTER TABLE consultas_veterinarias ya existe y tiene esas 9 filas. No la borramos: le agregamos una columna nueva con ALTER TABLE
...
-- UPDATE Asigna un veterinario a cada consulta
